...
{
	const KLocalizedString appName = ki18nc("application name", "KGameSettings");
	KAboutData about("kgamesettings", 0, appName, "0.1",
		ki18n("Global configuration interface for libkgame-based applications"),
	...
	KConfigDialog dialog(0, QString(), KgvSettings::self());
